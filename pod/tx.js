...
function udpTX(){
    ...
    view.setUint32(6, bin.uint32ToBytes(fakePodState.accelerometer0.flags, true), true);
    view.setUint16(10, bin.uint16ToBytes(fakePodState.accelerometer0.x, true), true);
    view.setUint16(12, bin.uint16ToBytes(fakePodState.accelerometer0.y, true), true);
    view.setUint16(14, bin.uint16ToBytes(fakePodState.accelerometer0.z, true), true);
    
    view.setUint32(16, bin.uint32ToBytes(fakePodState.accelerometer1.flags, true), true);
    view.setUint16(20, bin.uint16ToBytes(fakePodState.accelerometer1.x, true), true);
    view.setUint16(22, bin.uint16ToBytes(fakePodState.accelerometer1.y, true), true);
    view.setUint16(24, bin.uint16ToBytes(fakePodState.accelerometer1.z, true), true);
